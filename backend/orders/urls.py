...
from .views import create_order, get_orders, get_order_by_id, mark_order_delivered, checkout_details
...
urlpatterns = [
    ...
    path('checkout-details/', checkout_details, name='checkout-details'),
]
